	...
	<div class="container">
		...
		<div class="row h-100 fixed-top">
			...
			<div class="col-9" style="padding-left: 0px;">
				...
				<%
					if (request.getParameter("isVistor") == null || request.getParameter("isVistor").equals("true")) {
				%>
				<jsp:include page="postTemplateVisitorLogin.jsp" />
				<%
					} else {
				%>
				<jsp:include page="postTemplateHost.jsp" />
				<%
					}
				%>
			</div>
